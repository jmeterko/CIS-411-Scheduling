...
<meta http-equiv="refresh" content="3;url=../controller/controller.php?action=StudentQuestion" />

<body style="background-color: #becccc;">
<svg id="loading">
    <g>
        <path class="ld-l" fill="#000000" d="M43.6,33.2h9.2V35H41.6V15.2h2V33.2z"/>
        <path class="ld-o" fill="#000000" d="M74.7,25.1c0,1.5-0.3,2.9-0.8,4.2c-0.5,1.3-1.2,2.4-2.2,3.3c-0.9,0.9-2,1.6-3.3,2.2
        ...
        <path class="ld-a" fill="#000000" d="M78.2,35H76l8.6-19.8h2L95.1,35h-2.2l-2.2-5.2H80.4L78.2,35z M81.1,27.9h8.7l-4.4-10.5L81.1,27.9z"/>
        <path class="ld-d" fill="#000000" d="M98,15.2h6.6c1.2,0,2.5,0.2,3.7,0.6c1.2,0.4,2.4,1,3.4,1.9c1,0.8,1.8,1.9,2.4,3.1s0.9,2.7,0.9,4.3
        ...
        <path class="ld-i" fill="#000000" d="M121.2,35h-2V15.2h2V35z"/>
        <path class="ld-n" fill="#000000" d="M140.5,32.1L140.5,32.1l0.1-16.9h2V35h-2.5l-11.5-17.1h-0.1V35h-2V15.2h2.5L140.5,32.1z"/>
        <path class="ld-g" fill="#000000" d="M162.9,18.8c-0.7-0.7-1.5-1.3-2.5-1.7c-1-0.4-2-0.6-3.3-0.6c-1.3,0-2.4,0.2-3.4,0.7s-1.9,1.1-2.6,1.9
